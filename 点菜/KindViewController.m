...
//    菜单视图 tableview
    _muneTableView = [[UITableView alloc] initWithFrame:CGRectMake(1024-70, 60, 40, 768-140) style:UITableViewStylePlain];
    //    菜单行高
...
//  分割线设置为透明
    ...
    [self.view addSubview:_muneTableView];
    [self.view bringSubviewToFront:_muneTableView];
...
//    默认显示主厨推荐视图
    [self enterNextViewController:0];
